...
import AdapterPointer from './adapters/adapter_pointer';
import Adapter3DTouch from './adapters/adapter_3d_touch';
import AdapterForceTouch from './adapters/adapter_force_touch';
