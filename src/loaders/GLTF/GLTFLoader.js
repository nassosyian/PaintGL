...
var GLTFLoader = ( function () {
	...
	GLTFMaterialsUnlitExtension.prototype.getMaterialType = function ( material ) {
		...
		return {color: [], opacity: 1.0, pbrMetallicRoughness:[], };
	...
	GLTFMaterialsUnlitExtension.prototype.extendParams = function ( materialParams, material, parser ) {
		...
		materialParams.color = [1,1,1];//new THREE.Color( 1.0, 1.0, 1.0 );
	...
	var WEBGL_SIDES = {
		...
		1028: 'front', // Culling front
		1029: 'back' // Culling back
	...
	GLTFParser.prototype.loadTexture = function ( textureIndex ) {
		...
		return Promise.resolve( sourceURI ).then( function ( sourceURI ) {
			...
			if ( textureDef.internalFormat !== undefined && texture.format !== WEBGL_TEXTURE_FORMATS[ textureDef.internalFormat ] ) {
				...
				console.warn( 'GLTFLoader: there is no support for texture internalFormat which is different from texture format. ' +
			...
			return scope.loadGeometries( primitives ).then( function ( geometries ) {
				...
				for ( var i = 0, il = primitives.length; i < il; i ++ ) {
					...
					if ( material.aoMap
						...
						log( 'GLTFLoader: Duplicating UVs to support aoMap.' );
	...
	GLTFParser.prototype.loadCamera = function ( cameraIndex ) {
		...
		if ( cameraDef.type === 'perspective' ) {
			...
			camera = new THREE.PerspectiveCamera( _Math.radToDeg( xfov ), aspectRatio, params.znear || 1, params.zfar || 2e6 );
